...
myPlugin.FormValidator.prototype.getFieldContainer = function (field) {
  return this.option.formDOM.querySelector("[".concat(myPlugin.FormValidator.dataConfig.fieldContainer, "=\"").concat(field, "\"]"));
};
/**
 * 得到表单字段元素
